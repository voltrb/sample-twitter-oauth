...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'sample-twitter-oauth.com'
  config.app_name = 'Sample-twitter-oauth'
  config.mailer.from = 'Sample-twitter-oauth <no-reply@sample-twitter-oauth.com>'
  ...
  #
  config.app_secret = 'DNKOoJ0YRPRAUNKX7f2eYg0f2pMv7lB6MmXvut0Twi6L083ipPflt2gNv6IFxSQevss'
